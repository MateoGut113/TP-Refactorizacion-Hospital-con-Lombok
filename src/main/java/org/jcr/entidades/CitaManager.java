...
//No conviene aplicar Lombok directamente a la clase. Usar Lombok aquí sería innecesario y podría incluso confundir el diseño.
...
public class CitaManager implements CitaService {
    ...
    public Cita programarCita(Paciente paciente, Medico medico, Sala sala,
        ...
        Cita cita = Cita.builder().paciente(paciente).medico(medico).sala(sala).fechaHora(fechaHora).costo(costo)
                .build();
        citas.add(cita);
